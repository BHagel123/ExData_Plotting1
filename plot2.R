...
#plot 2 code
png(file="C:/Users/bhage/Dropbox/Brent/Sabbatical_Coursework_2024/Exploratory_Data_Analysis/Assign1/plot2.png",width=480,height=480)
library(lubridate)
assign1_feb$DateTime <- strptime(paste(assign1_feb$Date, assign1_feb$Time), format="%d/%m/%Y %H:%M:%S")
plot(assign1_feb$DateTime, assign1_feb$Global_active_power, type="l", col="black", lwd=1, ylab="Global Active Power (kilowatts)",xaxt = "n", xlab="")
